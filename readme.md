...
- Trader specific configuration:
  ...
  - <code>buy_strategies</code> is a two-dimensional array of strategies (either the string identifier or a dictionary of properties).
   Each child array is a strategy. During the trading cycle the bot will consult 
   each strategy on whether it determines
